...
ggplot(aes(x = heg, y = fit), data = physical_preds) +
                        ...
                        geom_line(color = 'blue') + 
                          labs(title="Predicted quality of life for a standardized patient" , 
                              ...
                              scale_x_continuous(limits=c(-40, 20), breaks=c(-40, -20, 0, 20)) +
